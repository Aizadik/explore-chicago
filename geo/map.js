...
$(document).ready(function () {
  ...
  $(".buttons").on("click", function(event){;
      $("#map").empty();
      $("#panel").empty();
      console.log($(event.target).attr("data-places"))
    function geocode(platform) {
      var geocoder = platform.getGeocodingService(),
        geocodingParameters = {
          searchText: $(event.target).attr("data-places"),
          jsonattributes : 1
        };
    ...
    var platform = new H.service.Platform({
      'apikey': 'rBqwxeaL_0J7oxiySo14QGOFMGH0bYQlhZb5lyXLW2g'
    });
    ...
    function addLocationsToPanel(locations){
      ...
      for (i = 0;  i < locations.length; i += 1) {
        var li = document.createElement('li'),
            ...
            content =  '<strong style="font-size: large; color: white;">' + address.label  + '</strong></br>';
            position = {
